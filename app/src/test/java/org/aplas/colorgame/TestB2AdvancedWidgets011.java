...
public class TestB2AdvancedWidgets011 extends ViewTest {
    private MyActivity activity;
    private final String layoutName = "activity_layout";
    private final String appName  = "ColorGame";
    private final String compDomain = "org.aplas.colorgame";
    private final String targetDevice = "9";
    private final String actName = "MyActivity";
    private final String backwardComp = "Activity";
