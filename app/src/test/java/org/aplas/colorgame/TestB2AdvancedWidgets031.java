...
public class TestB2AdvancedWidgets031 extends ViewTest {
    ...
    private void checkCompletion() {
        ...
        elements.add(TextView.class); //Element 1
    ...
    public void check_1_TextView_appTitle() {
        //Preprocessing
        TextView component = (TextView) mainLayout.getChildAt(0);
    ...
    private void check_accessBox_Components(ViewGroup layout) {
        List<Class> elements = new ArrayList<>();
        elements.add(EditText.class); //Element 1
        elements.add(Button.class);  //Element 2
        testCompletion(0,elements,layout);

        //Check 1st element
        EditText component1 = (EditText) layout.getChildAt(0);
        ...
        //Check 2nd element
        Button component2 = (Button) layout.getChildAt(1);
    ...
    private void check_colorBox_Components(ViewGroup layout) {
        List<Class> elements = new ArrayList<>();
        elements.add(TextView.class); //Element 1
        elements.add(Space.class);  //Element 2
        elements.add(TextView.class);  //Element 3
        testCompletion(0,elements,layout);

        //Check 1st element
        TextView component1 = (TextView) layout.getChildAt(0);
        ElementTest comp1 = new ElementTest(component1);
        ...
        //Check 3rd element
        TextView component3 = (TextView) layout.getChildAt(2);
    ...
    private void check_buttonBox1_Components(ViewGroup layout) {
        List<Class> elements = new ArrayList<>();
        elements.add(Button.class); //Element 1
        elements.add(Button.class);  //Element 2
        elements.add(Button.class);  //Element 3
        testCompletion(0,elements,layout);
        ...
        //Check 1st element
        Button component1 = (Button) layout.getChildAt(0);
        ElementTest comp1 = new ElementTest(component1);
        ...
        //Check 3rd element
        Button component3 = (Button) layout.getChildAt(2);
        ElementTest comp3 = new ElementTest(component3);
    ...
    private void check_buttonBox2_Components(ViewGroup layout) {
        List<Class> elements = new ArrayList<>();
        elements.add(Button.class); //Element 1
        elements.add(Button.class);  //Element 2
        elements.add(Button.class);  //Element 3
    ...
    private void check_scoreBox_Components(ViewGroup layout) {
        List<Class> elements = new ArrayList<>();
        elements.add(TextView.class); //Element 1
        elements.add(TextView.class);  //Element 2
        elements.add(TextView.class);  //Element 3
        testCompletion(0,elements,layout);
        ...
        //Check 2nd element
        TextView component2 = (TextView) layout.getChildAt(1);
        ElementTest comp2 = new ElementTest(component2);
    ...
    private void check_progressBox_Components(ViewGroup layout) {
        ...
        //Check 4th element
        Button component4 = (Button) layout.getChildAt(3);
